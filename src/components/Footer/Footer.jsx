  ...
  return (
    <div className="bg-[#244D3F] text-center">
      <div className="pt-20 max-w-[70%] mx-auto">
        ...
        <div className="border-b-amber-100 border-b pb-5">
          <nav>
            <h6 className="footer-title text-2xl text-white">Social</h6>
            <div className="mx-auto flex justify-center gap-4 text-white">
              <a>
                <svg
